...
\hypersetup{
    ...
    pdfauthor={Debadri Basak},                     % author
...
%\begin{description}[font=$\bullet$\scshape\bfseries] %this is for bullet points
...
%\textbf{Changing Description}\\
%\textit{Goal: } To create an Account inside the system\\
%\textit{Primary Actor: } Users of the system, namely the enterprises or any individual person\\
%\textit{Precondition: }None\\
%\textit{Main Success Scenarios:} Lores ipsum dolor sit amet\\
%\textit{Exceptional Scenarios:} Lores ipsum dolor sit amet\\\\
...
\textit{Precondition: } User must log into the system\\
\textir{Main Success Scenarios: }1. On the home page click on the 'Request for HR Services' button\\
